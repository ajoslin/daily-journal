App.controller('TodayEntryCtrl', [
  '$scope',
  '$user',
  'jsonDateFilter',
  '$firebase',
  'appFirebase',
  function ($scope, $user, jsonDateFilter, $firebase, appFirebase) {
    ...
    if (!localStorage.entryDate || localStorage.entryDate != jsonDateFilter()) {
    ...
    function initRemote() {
      var ref = $firebase(appFirebase.child($user.uid()).child(jsonDateFilter()));
